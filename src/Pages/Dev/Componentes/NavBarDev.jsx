// src/Pages/Dev/Componentes/NavBarDev.jsx
...
export const NavBarDev = ({ usuario, vistaActiva, onCambiarVista }) => {
  ...
  return (
    ...
    >
      <Container fluid>
        ...
        <Navbar.Toggle aria-controls="navbar-dev" />

        <Navbar.Collapse id="navbar-dev">
