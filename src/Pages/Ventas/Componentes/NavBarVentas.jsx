...
export const NavBarVentas = ({ usuario, vistaActiva, onCambiarVista }) => {
  const navigate = useNavigate();

  const opciones = [
    { label: 'Dashboard', icon: 'bi-speedometer2', vista: 'dashboard' },
    { label: 'Nueva Venta', icon: 'bi-cart-plus', vista: 'nueva-venta' },
  ...
  return (
    ...
    >
      <Container fluid>
        ...
        <Navbar.Toggle aria-controls="navbar-ventas" />

        <Navbar.Collapse id="navbar-ventas">
